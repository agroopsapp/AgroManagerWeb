...
import { WorkPartsSavedPanel } from "@/components/WorkPartsSavedPanel";
    ...
    <div className="min-w-0 max-w-full space-y-4">
      ...
      <div className="grid min-w-0 max-w-full gap-4 md:grid-cols-[minmax(0,2fr)_minmax(0,3fr)]">
        ...
        <HistorialPersonal
          ...
          miWorkerId={panel.miWorkerId}
          sessionEmail={user?.email}
          workPartSummaryByDate={fichaje.workPartSummaryByDate}
        />
      </div>

      <WorkPartsSavedPanel
        workerId={panel.miWorkerId}
        workerDisplayName={workerNameById(panel.miWorkerId)}
      />
      ...
      {breakModal.restModalStep !== "closed" &&
        (fichaje.openEntry || breakModal.workPartOverrideEntry) && (
          <BreakModal
