...
const STATUS_LABELS: Partial<Record<TimeEntryApiStatus | "unknown", string>> = {

  FestivoEmpresa: "Festivo empresa",
    ...
    <span
      ...
      title={
        ...
        status === "unknown"
          ...
          ? "Valor de estado no reconocido (revisar datos del servidor o registros antiguos)"
